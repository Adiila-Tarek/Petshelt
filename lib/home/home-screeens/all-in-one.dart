...
import '../newpostevent/newpost.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title : Padding(
            ...
            child: Text('all',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w400,fontStyle: FontStyle.normal,fontFamily: 'Inter',color: Color.fromARGB(255,250, 250, 250),),),
            //Pet\$helt
          ),
          bottom: AppBar(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) =>AdoptNewpost()));
