...
class Saved extends StatelessWidget {
 ...
 getdata()async{
   CollectionReference useresref = FirebaseFirestore.instance.collection("users");
   QuerySnapshot querySnapshot = await useresref.get();
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text('User_Name',style: TextStyle(fontFamily:'Inter' ,fontWeight: FontWeight.w500,fontSize: 15),),
                        ),
                      ]
                    ),
                  ),
